...
<%@ page import="org.project.ClientSocket,org.project.util.ChatUtil" %>
<%@ page import="org.project.DB.ChatMessageDB,org.project.model.ChatMessage" %>
...
<%
    ...
    List<ChatMessage> dbMessages = db.getMessagesByRoom(roomId);

    // Add database messages to the messages list if not already added
    for (ChatMessage m : dbMessages) {

        String formattedMsg = m.getUsername() + ": " + m.getMessage();
        if (!messages.contains(formattedMsg)) {
...
//            formattedTime = sdf.format(m.getTimestamp());
//        } else {
//            formattedTime = "unknown time";
//        }
//
//        String formattedMsg = m.getUsername() + ": " + m.getMessage() + " [" + formattedTime + "]";
//        if (!messages.contains(formattedMsg)) {
//            messages.add(formattedMsg);
//        }
//    }
    ...
    if (newMessage != null && !newMessage.trim().isEmpty()) {
        ...
        chatMsg.setUsername(user);
        chatMsg.setMessage(newMessage);
        db.save(chatMsg);  // use your existing ChatMessageDB
    }
